  ...
  function (Controller, MessageToast, JSONModel) {
    ...
    return Controller.extend("test.test.controller.App", {
      ...
      onSaveProcessData: function () {
        ...
        const first_weighing = parseFloat(this.byId("firstweighingInput").getValue());
        const last_weighing = parseFloat(this.byId("lastweighingInput").getValue());
        ...
        if (
            ...
            sap.m.MessageToast.show("Lütfen tüm alanları doldurun ve geçerli değerler girin.");
            return;
        }
        ...
        fetch("http://localhost:3000/suppliers", {
            ...
            .then((data) => {
                sap.m.MessageToast.show("Supplier data başarıyla kaydedildi!");
